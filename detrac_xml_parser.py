...
if (__name__ == "__main__"):
    # print("main")
    basePath = "/media/xzgz/ubudata/Ubuntu/Data/UA-DETRAC/DETRAC-Train-Annotations-XML"
    totalxml = os.listdir(basePath)
    total_num = 0
    flag = False
    print("正在转换")
    saveBasePath = "/media/xzgz/ubudata/Ubuntu/Data/UA-DETRAC/DETRAC-train-xml"
    ...
    visualization_image("/media/xzgz/ubudata/Ubuntu/Data/UA-DETRAC/Insight-MVT_Annotation_Train/MVI_40212/img00396.jpg",
                        "/media/xzgz/ubudata/Ubuntu/Data/UA-DETRAC/DETRAC-train-xml/MVI_40212__img00396.xml")
